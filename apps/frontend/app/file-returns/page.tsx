        ...
        <div className="px-6 py-6">
          ...
          <div className="mt-6">
            <button
              ...
              className="rounded bg-primary px-8 py-2.5 text-sm font-semibold text-primary-foreground transition hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
            >
              SEARCH
            </button>
          </div>
