  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-5xl px-6 py-8">
        ...
        <div className="rounded-lg border border-border bg-surface p-6 shadow-sm">
            ...
            <div className="mb-6 flex flex-wrap gap-4">
              <div>
                ...
                <select
                  ...
                  className="rounded border border-border bg-surface px-3 py-1.5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary"
                >
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full max-w-sm rounded border border-border bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
              onKeyDown={(e) => {
        ...
        {/* Error alert */}
        {error && (
          <div className="mt-4 rounded-lg border border-status-danger-text bg-status-danger-bg px-4 py-3 text-sm text-status-danger-text">
            {error}
          </div>
        )}
