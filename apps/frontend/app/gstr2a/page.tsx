          ...
          <div key={group.part}>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {group.sections.map((section) => (
                <button
                  key={section.id}
                  className="group flex items-center justify-between rounded-lg bg-primary px-5 py-4 text-left transition hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
                >
                  <div>
